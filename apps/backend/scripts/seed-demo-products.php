...
$simple_products = [
    ...
    [
        'name' => 'Pack coleccionista Mythic Mint - Oferta',
        'slug' => 'pack-coleccionista-mythic-mint-oferta',
        ...
        'tags' => ['Rebajas', 'Bundle'],
        'short_description' => 'Pack en rebaja para validar filtros de ofertas y precio tachado.',
    ...
    [
        'name' => 'Carta individual Dragon Warden - Bajo stock',
        'slug' => 'carta-individual-dragon-warden-bajo-stock',
        ...
        'short_description' => 'Carta individual con pocas unidades disponibles para validar avisos de bajo stock.',
        'description' => 'Stock configurado por debajo del umbral demo para que la tienda pueda mostrar badge de ultimas unidades.',
    ],
    [
        'name' => 'Carta promo Eclipse Sentinel - Agotada',
        'slug' => 'carta-promo-eclipse-sentinel-agotada',
        ...
        'short_description' => 'Producto agotado para probar bloqueos de carrito, badges y filtros de disponibilidad.',
